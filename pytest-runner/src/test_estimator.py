...
class Test_JSONOutput(Resource):
...
api.add_resource(Test_Estimator, '/api/v1/on-covid-19')
api.add_resource(Test_JSONOutput, '/api/v1/on-covid-19/json')
api.add_resource(Test_XMLOutput, '/api/v1/on-covid-19/xml')
api.add_resource(Test_COVIDLogs, '/api/v1/on-covid-19/logs')
